    ...
    {   
       // dd($request->all());
        $this->validate($request,[ 
            ...
            "registration_no" => 'required|max:199|unique:students',
            "admission_no" => 'max:199|unique:students',
            "roll_no" => 'max:199|unique:students',
            ...
            "father_mobile" => 'required|max:13',
            "mother_mobile" => 'required|max:30',
