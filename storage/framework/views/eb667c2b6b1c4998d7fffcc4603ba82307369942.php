                 ...
                 <div class="modal-body">
                   <form id="parents-form">
                    <div class="form-group">
                         <?php echo e(Form::label('relation_type_id','Parents',['class'=>' control-label'])); ?>

                         <?php echo Form::select('relation_type_id',$parentsType, null, ['class'=>'form-control','placeholder'=>'Select Parents','required']); ?>

                         <p class="text-danger"><?php echo e($errors->first('parents')); ?></p>
                    </div>
                    <div class="form-group">
                        <?php echo e(Form::label('name','Parents Name',['class'=>' control-label'])); ?>                         
                        <?php echo e(Form::text('name','',['class'=>'form-control',' required'])); ?>

                        <p class="text-danger"><?php echo e($errors->first('name')); ?></p>
                    </div>
                    <div class="form-group">
                        <?php echo e(Form::label('education','Education',['class'=>' control-label'])); ?>                         
                        <?php echo e(Form::text('education','',['class'=>'form-control'])); ?>

                        <p class="text-danger"><?php echo e($errors->first('education')); ?></p>
                    </div>
                    <div class="form-group">
                        <?php echo e(Form::label('occupation','Occupation',['class'=>' control-label'])); ?>                         
                        <?php echo e(Form::text('occupation','',['class'=>'form-control '])); ?>

                        <p class="text-danger"><?php echo e($errors->first('occupation')); ?></p>
                    </div>                                        
                   <div class="form-group">
                        <?php echo e(Form::label('income','Income Range',['class'=>' control-label'])); ?>

                        <?php echo Form::select('income',$incomes, null, ['class'=>'form-control','placeholder'=>'Select income','required']); ?>

                        <p class="text-danger"><?php echo e($errors->first('income')); ?></p>
                   </div>
                   <div class="form-group">
                        <?php echo e(Form::label('mobile','Mobile',['class'=>' control-label'])); ?>                         
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <?php echo e(Form::text('dob','',['class'=>'form-control datepicker'])); ?>

                        <p class="text-danger"><?php echo e($errors->first('dob')); ?></p>
                    </div>
                     <div class="form-group">
                        <?php echo e(Form::label('doa','Date of Anniversary',['class'=>' control-label '])); ?>                         
                        <?php echo e(Form::text('doa','',['class'=>'form-control datepicker'])); ?>

                        <p class="text-danger"><?php echo e($errors->first('doa')); ?></p>
                    </div>                  
                    <div class="form-group">
                        <?php echo e(Form::label('office_address','Office Address',['class'=>' control-label'])); ?>                         
                        <?php echo e(Form::textarea('office_address','',['class'=>'form-control','rows'=>2 ])); ?>

                        <p class="text-danger"><?php echo e($errors->first('office_address')); ?></p>
                    </div>
                    <div class="form-group">
                        <?php echo e(Form::label('islive','IsLive',['class'=>' control-label'])); ?>                         
                        <?php echo Form::select('islive',[
                          '0'=>'No',
                          '1'=>'Yes'                                                    
                          ], null, ['class'=>'form-control']); ?>

                        <p class="text-danger"><?php echo e($errors->first('islive')); ?></p>
                    </div>
                    </form>                     
...
<script type="text/javascript">  
     $(document).ready(function() {                                       
        $("#relation_type_id").on("change", function() {
            $("#name").val( this.value == 1 ? '<?php echo e($student->father_name); ?>' : this.value == 2 ? '<?php echo e($student->mother_name); ?>' : '' );
 ...
 $('.modal-footer').on('click', '.save_btn_parets', function() {    
        ...
        $.ajax({
            url: "<?php echo e(route('admin.parents.add')); ?>",
            type: "POST",            
            data: $('#parents-form').serialize() + '&student_id=' + <?php echo e($student->id); ?>,  
        })
        .done(function(data) {
    ...
    $( "#parents_items" ).on( "click", ".parents_delete", function() { 
        ...
        $.ajax(
        {
            url: "<?php echo e(route('admin.parents.delete')); ?>",
 ...
 $( "#parents_items" ).on( "click", ".parents_edit", function() {   
    ...
    $.ajax(
    {
        url: "<?php echo e(route('admin.parents.edit')); ?>",
    ...
    .done(function( response ) {    
       ...
       // Update medeical information  
        $('.modal-footer').on('click', '.update_btn_parets', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.parents.update')); ?>",              
              type: "POST",            
              data: $('#parents-form').serialize() + '&student_id=' + <?php echo e($student->id); ?>,                  
            })
           .done(function(data) {
