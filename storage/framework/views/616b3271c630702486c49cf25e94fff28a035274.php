          ...
          <div class="box">
            ...
            <div class="col-md-8">
              <table id="dataTable" class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                <?php $__currentLoopData = $manageSubjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manageSubject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <td><?php echo e($manageSubject->id); ?></td>
                  <td><?php echo e($manageSubject->classTypes->name); ?></td>                 
                  <td><?php echo e($manageSubject->subjectTypes->name); ?></td>                 
                  <td><?php echo e($manageSubject->isoptional->name); ?></td>                 
                  <td align="center">                    
                    
                    <a class="btn btn-danger btn-xs" onclick="return confirm('Are you sure to delete this data ?')" href="<?php echo e(route('admin.manageSubject.delete',$manageSubject->id)); ?>"><i class="fa fa-trash"></i></a>                     
                  </td>                 
                </tr>
...
<script type="text/javascript">
  $("#class").change(function(){   
        ...
        $.ajax({
          method: "get",
          url: "<?php echo e(route('admin.subject.search')); ?>",
          data: $(this).serialize(),
  ...
  $("#saveSubject").submit(function(e){
        ...
        $.ajax({
          method: "post",
          url: "<?php echo e(route('admin.subject.add')); ?>",
