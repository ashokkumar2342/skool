		  		...
		  		<tbody>
		  			<?php $__currentLoopData = $StudentFeeDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $StudentFeeDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		  				<tr>
		  					...
		  					<td><input type="text" name="" value="<?php echo e($StudentFeeDetail->fee_amount); ?>"></td>
		  			...
		  			<tr>
		  				<td>Concession</td>
		  				<td>
		  					<input type="text" name="" value="<?php echo e($StudentFeeDetails->sum('concession_amount')); ?>"> 
		  				</td>
		  			</tr>
		  			<tr>
		  				<td>
		  			...
		  			<tr>
		  				...
		  				<td>
		  					<input type="text" name="" value="<?php echo e($StudentFeeDetails->sum('fee_amount') - $StudentFeeDetails->sum('concession_amount')); ?>"> 
		  				</td>
		  			</tr>
		  			<tr>
		  				<td>
		  				...
		  				<td>
		  					<select name="payment_mode">
		  						<?php $__currentLoopData = App\Model\PaymentMode::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		  							<option value=""><?php echo e($mode->name); ?></option> 
		  						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
		  					</select>
		  				</td>
		  			</tr>
