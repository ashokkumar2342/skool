                 ...
                 <div class="modal-body">
                   ...
                   <form id="remarks-form">
                    ...
                    <div class="form-group">
                        <?php echo e(Form::label('remark','Remarks',['class'=>' control-label'])); ?>                         
                        <?php echo e(Form::textarea('remark','',['class'=>'form-control','rows'=>2 ])); ?>

                        <p class="text-danger"><?php echo e($errors->first('remark')); ?></p>
...
<script type="text/javascript">  
 ...
 $('.modal-body').on('click', '.btn_add_remark', function() {    
       var id = $('certificate_id').val();
        ...
        $.ajax({
            url: "<?php echo e(route('admin.remark.add')); ?>",
            type: "POST",            
...
$( "#dataTable" ).on( "click", ".btn_add_remarks", function() {
    ...
    $.ajax({
        url: "<?php echo e(route('admin.remark.show')); ?>",
        type: "get",            
        data: {id:id},  
    })
