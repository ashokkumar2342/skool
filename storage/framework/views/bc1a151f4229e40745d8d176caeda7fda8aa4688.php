                    ...
                    <table id="fee_structure_table" class="display table">                     
                        ...
                        <?php $__currentLoopData = $feeStructures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feeStructure): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        	<tr>
                        		...
                        		<td><?php echo e($feeStructure->description); ?></td>
                        		<td> 
                        			<button type="button" class="btn_edit btn btn-warning btn-xs" data-toggle="modal" data-id="<?php echo e($feeStructure->id); ?>"  data-code="<?php echo e($feeStructure->code); ?>" data-name="<?php echo e($feeStructure->name); ?>" data-description="<?php echo e($feeStructure->description); ?>" data-target="#add_parent"><i class="fa fa-edit"></i> </button>
