                 ...
                 <div class="modal-body">
                   <form id="sibling-form">                    
                    <div class="form-group">
                         <?php echo e(Form::label('student_sibling_id','Student Sibling Registration No',['class'=>'control-label', 'required'])); ?>                         
                         <?php echo e(Form::text('student_sibling_id','',['class'=>'form-control'])); ?>

                         <p class="text-danger"><?php echo e($errors->first('student_sibling_id')); ?></p>
                     </div> 
                    </form>                     
...
$(document).ready(function(event) { 
    $('.btn_add_sibling_info').click(function(event) {
     ...
     $('.modal-footer').on('click', '.add_btn_sibling', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.sibling.add',$student->id)); ?>",
                type: "POST",            
                data:   
                    $('#sibling-form').serialize() + '&student_id=' + <?php echo e($student->id); ?>,                  
            })
            .done(function(data) {
    ...
    $( "#sibling_items" ).on( "click", ".btn_sibling_delete", function() { 
        ...
        $.ajax(
        {
            url: "<?php echo e(route('admin.sibling.delete')); ?>",
 ...
 $( "#sibling_items" ).on( "click", ".btn_sibling_edit", function() {   
    ...
    $.ajax(
    {
        url: "<?php echo e(route('admin.sibling.edit')); ?>",
    ...
    .done(function( response ) {   
     ...
     $('.modal-footer').on('click', '.update_btn_sibling', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.sibling.update')); ?>",
                type: "POST",            
                data:   
                    $('#sibling-form').serialize() + '&student_id=' + <?php echo e($student->id); ?>,                  
            })
