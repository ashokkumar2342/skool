                 ...
                 <div class="modal-body">
                   <form id="sport_hobby-form">                    
                     ...
                     <div class="form-group">
                          <?php echo e(Form::label('session_id','Academic Year Prize',['class'=>' control-label'])); ?>

                          <?php echo Form::select('session_id',$sessions, null, ['class'=>'form-control']); ?>

                          <p class="text-danger"><?php echo e($errors->first('session_id')); ?></p>
                     </div> 
                   <div class="form-group">
                        <?php echo e(Form::label('sports_activity_name','Sports Activity Name',['class'=>' control-label'])); ?>                         
                        <?php echo e(Form::text('sports_activity_name','',['class'=>'form-control'])); ?>

                        <p class="text-danger"><?php echo e($errors->first('sports_activity_name')); ?></p>
                    </div>                                       
...
<?php $__env->startPush('scripts'); ?>      
    ...
    $('.btn_add_sport_hobby').click(function(event) {
     ...
     $('.modal-footer').on('click', '.add_btn_sport_hobby', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.hobby.add')); ?>",
                type: "POST",            
                data:   
                    $('#sport_hobby-form').serialize() + '&student_id=' + <?php echo e($student->id); ?>,                  
            })
            .done(function(data) {
    ...
    $( "#sport_hobby_items" ).on( "click", ".btn_sport_hobby_delete", function() { 
        ...
        $.ajax(
        {
            url: "<?php echo e(route('admin.hobby.delete')); ?>",
 ...
 $( "#sport_hobby_items" ).on( "click", ".btn_sport_hobby_edit", function() {   
    ...
    $.ajax(
    {
        url: "<?php echo e(route('admin.hobby.edit')); ?>",
    ...
    .done(function( response ) {   
     ...
     $('.modal-footer').on('click', '.update_btn_sport_hobby', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.hobby.update')); ?>",
                type: "POST",            
                data:   
                    $('#sport_hobby-form').serialize() + '&student_id=' + <?php echo e($student->id); ?>,                  
            })
