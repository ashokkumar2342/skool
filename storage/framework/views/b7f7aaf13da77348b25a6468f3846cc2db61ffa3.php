              ...
              <!-- /.box-header -->
                <div class="box-body">
                    <table id="fee_structure_amount_table" class="display table">                     
                        ...
                        <tbody>
                        <?php $__currentLoopData = $feeStructureAmounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feeStructureAmount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        	<tr>
                        		<td width="30px"><?php echo e(++$loop->index); ?>  </td>
                            <td><?php echo e($feeStructureAmount->academicYears->name); ?></td>

                        		<td><?php echo e($feeStructureAmount->feeStructures->name); ?></td>
                                
                                <td><?php echo e($feeStructureAmount->amount); ?></td>
                               
                        	 
                        		<td> 
                        			<button type="button" class="btn_edit btn btn-warning btn-xs" data-toggle="modal" data-id="<?php echo e($feeStructureAmount->id); ?>"  data-academic="<?php echo e($feeStructureAmount->academic_year_id); ?>" data-feestructur="<?php echo e($feeStructureAmount->fee_structure_id); ?>"  data-amount="<?php echo e($feeStructureAmount->amount); ?>"><i class="fa fa-edit"></i> </button>

                        			<button class="btn_delete btn btn-danger btn-xs"  data-id="<?php echo e($feeStructureAmount->id); ?>"  ><i class="fa fa-trash"></i></button>
                        		</td>
                        	</tr>  	 
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>	
                    <?php echo e($feeStructureAmounts->links()); ?>
                          ...
                          <div class="modal-body">
                            <form id="form_model_fee_structure"> 
                               ...
                               <div class="form-group">
                                ...
                                <?php echo e(Form::select('fee_structure_id',$feeStructur,null,['class'=>'form-control','id'=>'edit_fee_structure_id'])); ?>

                               </div>  
                                <div class="form-group">
                                <?php echo e(Form::label('academic_year_id','Academic Year',['class'=>' control-label'])); ?>

                                <?php echo e(Form::select('academic_year_id',$acardemicYear,null,['class'=>'form-control','id'=>'edit_academic_year_id'])); ?>

                               </div>    
                               <div class="form-group">
                                <?php echo e(Form::label('amount','Amount',['class'=>' control-label'])); ?>                                
                                 <?php echo e(Form::text('amount','',['class'=>'form-control','id'=>'edit_amount','rows'=>4, 'placeholder'=>'Enter fee structure amount'])); ?>
 ...
 <script>
  ...
  <script>
  	$('#btn_fee_structure_amount_create').click(function(event) {  		  
	     ...
	     $.ajax({
           url: '<?php echo e(route('admin.feeStructureAmount.post')); ?>',
           type: 'POST',       
  	...
  	$('#fee_structure_amount_table').on('click', '.btn_delete', function(event) {
  		...
  		if (cm == true) {
  		     ...
  		     $.ajax({
  		         url: '<?php echo e(route('admin.feeStructureAmount.delete')); ?>',
  		         type: 'delete',
  		         data: {id: id},
  		     })
  		     .done(function(data) {
 	 ...
 	 $('#fee_structure_amount_model').on('click', '.btn_update', function(event) {     
	     ...
	     $.ajax({
           url: '<?php echo e(route('admin.feeStructureAmount.update')); ?>',
           type: 'put',       
