                         ...
                         <div class="col-lg-2">                           
                             <div class="form-group">
                              <?php echo e(Form::label('fee_structure_id','Fee Structure',['class'=>' control-label'])); ?>
                               ...
                               <?php echo e(Form::select('fee_structure_id',$feeStructur,null,['class'=>'form-control','placeholder'=>'--Select Fee Structure--'])); ?>
 ...
 <script>
  ...
  <script>
   ...
   $('#fee_structure_id').change(function(event) {   
      $.ajax({
       url: '<?php echo e(route('admin.feeStructureAmount.search')); ?>',
       type: 'get', 
       data: { id: $(this).val() },
     })
