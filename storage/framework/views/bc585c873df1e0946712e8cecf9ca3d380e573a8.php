         ...
         <section class="col-lg-5 connectedSortable">
           ...
           <div class="box box-solid bg-light-blue-gradient">
             ...
             <div class="box-body">
                  ...
                  <input type="hidden" name="present" id="present" value="<?php echo e(presentStudent()); ?>">
                  <input type="hidden" name="absent" id="absent" value="<?php echo e(absentStudent()); ?>"> 
             </div>
             <!-- /.box-body-->
...
<script src="<?php echo e(asset('admin_asset/plugins/chartjs/Chart.js')); ?>"></script>
