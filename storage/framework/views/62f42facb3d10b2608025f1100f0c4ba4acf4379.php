                 ...
                 <div class="modal-body">
                   <form id="subject-form">                    
                    <div class="form-group">
                         <?php echo e(Form::label('subject_type_id','Subject Type',['class'=>' control-label'])); ?>

                         <?php echo Form::select('subject_type_id',$subjectTypes, null, ['class'=>'form-control','placeholder'=>'Select Subject','required']); ?>

                         <p class="text-danger"><?php echo e($errors->first('subject_type_id')); ?></p>
                    </div>
                      <div class="form-group">
                         <?php echo e(Form::label('isoptional_id','isoptional_id',['class'=>' control-label'])); ?>

                         <?php echo Form::select('isoptional_id',$isoptionals, null, ['class'=>'form-control','placeholder'=>'Select Subject','required']); ?>

                         <p class="text-danger"><?php echo e($errors->first('isoptional_id')); ?></p>
                    </div> 
                    <input type="hidden" name="session_id" id="session_id" value="<?php echo e($student->sessions->id); ?>">
                    </form>                     
...
$(document).ready(function(event) { 
    $('.add_subject').click(function(event) {
     ...
     $('.modal-footer').on('click', '.add_btn_subject', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.studentSubject.add')); ?>",
                type: "POST",            
                data:   
                    $('#subject-form').serialize() + '&student_id=' + <?php echo e($student->id); ?>,                  
            })
            .done(function(data) {
    ...
    $( "#subject_items" ).on( "click", ".btn_student_subject_delete", function() { 
        ...
        $.ajax(
        {
            url: "<?php echo e(route('admin.studentSubject.delete')); ?>",
 ...
 $( "#subject_items" ).on( "click", ".btn_student_subject_edit", function() {   
    ...
    $.ajax(
    {
        url: "<?php echo e(route('admin.studentSubject.edit')); ?>",
    ...
    .done(function( response ) {    
     ...
     $('.modal-footer').on('click', '.update_btn_add_subject', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('admin.studentSubject.update')); ?>",
                type: "POST",            
                data:   
                    $('#add_subject-form').serialize() + '&student_id=' + <?php echo e($student->id); ?>,                  
            })
            .done(function(data) {
