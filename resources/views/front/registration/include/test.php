{{--     <div class="col-lg-3">                         
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div class="timeline-item">
                                                                        <div class="timeline-body">
                                                                            <div class="row">
                                                                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 text-center b-r reg-stud-detail text-center">
                                                                                    ...
                                                                                    <div class="useimg">
                                                                                        ...
                                                                                        <img src="" id="ImgStudent" alt="" style="height:100px; width:100px;cursor:pointer;border: 3px solid #e6e5e5;" class="img-circle" onerror="return fRemove();" onclick="ImgUpload('fuStudent');" />

                                                                                        <a class="remove-img tooltip2" id="lnkRemove" onclick="return fRemove('ImgStudent','lnkRemove','lnkAdd')">
                                                                                            <i class="glyphicon glyphicon-remove-sign"></i><span style="display:none;" class="fa fa-asterisk"></span>
                                                                                            <span class="tooltiptext">Remove Photo</span>
                                                                                        </a>

                                                                                        <a class="add-img tooltip2" id="lnkAdd" onclick="ImgUpload('fuStudent');">
                                                                                            <i class="icon icon-ios-compose"> </i><span style="display:none;" class="fa fa-asterisk"></span>
                                                                                    ...
                                                                                    <div class="col-lg-6 b-r">
                                                                                        <div class="form-horizontal">
                                                                                            <div class="box-body">
                                                                                                <div class="form-group">
                                                                                                    <div class="col-sm-12">
                                                                                                        <input type="text" class="form-control input-sm" id="txtFName" style="text-transform:uppercase;" autocomplete="off" maxlength="50" onkeypress="return Restrict_Name(event);" required />
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <div class="col-sm-12">
                                                                                                        <input type="text" class="form-control input-sm" id="txtMName" style="text-transform:uppercase;" autocomplete="off" maxlength="50" onkeypress="return Restrict_Name(event);" required />
                                                                                                        <b class="floating-lable">Middle Name</b>
                                                                                                    </div>
                                                                                                </div>

                                                                                                <div class="form-group">
                                                                                                    <div class="col-sm-12">
                                                                                                        <input type="text" class="form-control input-sm" id="txtLName" style="text-transform:uppercase;" autocomplete="off" maxlength="50" onkeypress="return Restrict_Name(event);" required />
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <div class="col-md-12">
                                                                                                        <select class="form-control input-sm" data-val="true" data-val-number="The field YAcaStart must be a number." id="YAcaStart" name="YAcaStart" onchange="return fClassBind();" required="required"><option value=""> </option>
                                        <option value="2018">2018-2019</option>
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <div class="col-sm-12">
                                                                                                        <input id="DateBirth" class="form-control input-sm" type="text" value="Date of Birth" maxlength="10" onchange="javascript:return AgeInWords('DateBirth','lblAgeValue');" required />
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <div class="col-md-12">
                                                                                                        <select class="form-control input-sm" data-val="true" data-val-number="The field MTID must be a number." id="MTID" name="MTID" required="required"><option value=""> </option>
                                        ...
                                        <option value="7">SPANISH</option>
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <div class="col-md-12">
                                                                                                        <input type="text" class="form-control input-sm" id="txtAddEmail" maxlength="60" autocomplete="off" required />
                                                                                    ...
                                                                                    <div class="col-lg-6">
                                                                                        <div class="form-horizontal">
                                                                                            <div class="box-body">
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <div class="col-md-12">
                                                                                                        <select class="form-control input-sm" data-val="true" data-val-number="The field RelID must be a number." id="RelID" name="RelID" required="required"><option value=""> </option>
                                        ...
                                        <option value="2">SIKH</option>
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <div class="col-sm-12">
                                                                                                        <select class="form-control input-sm " data-val="true" data-val-number="The field GenderID must be a number." id="GenderID" name="GenderID" required="required"><option value=""> </option>
                                        ...
                                        <option value="3">TransGender</option>
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <div class="col-sm-12">
                                                                                                        ...
                                                                                                        <select class="form-control input-sm" data-val="true" data-val-number="The field CLID must be a number." id="ClsID" name="CLID" required="required"><option value=""> </option>
                                        ...
                                        <option value="13">10</option>
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <div class="col-md-12">
                                                                                                        <select class="form-control input-sm" data-val="true" data-val-number="The field SocialCategoryID must be a number." id="SocialCategoryID" name="SocialCategoryID" required="required"><option value=""> </option>
                                        ...
                                        <option value="2">RTE</option>
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <div class="col-md-12">
                                                                                                        <select class="form-control input-sm" id="StaffWard" name="StaffWard" required="required"><option value=""></option>
                                        ...
                                        <option value="N">NO</option>
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <div class="col-md-12">
                                                                                                        <select class="form-control input-sm" data-val="true" data-val-number="The field LocalityID must be a number." data-val-required="The LocalityID field is required." id="LocalityID" name="LocalityID" required="required"><option value=""> </option>
                                        ...
                                        <option value="8">DLF 2</option>
                                        <option value="9">DLF 3</option>
                                        <option value="10">DLF 4</option>
                                        <option value="7">DLF PHASE I</option>
                                        <option value="11">OTHERS</option>
                                        <option value="6">SECTOR 52</option>
                                        <option value="5">SECTOR 53</option>
                                        <option value="2">SECTOR 54</option>
                                        <option value="17">sector 54</option>
                                        <option value="18">sector 55</option>
                                        <option value="3">SECTOR 55</option>
                                        <option value="4">SECTOR 56</option>
                                        <option value="1">SUNCITY TOWNSHIP</option>
                                        </select>
                                                                        ...
                                                                        <div class="timeline-body">
                                                                            <div class="row">
                                                                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 text-center b-r reg-fath-detail" style="font-size: 25px; line-height: 34px">
                                                                                    <div class="useimg">
                                                                                        <input type="file" id="fuFather" class="filesearch inputfilehide  fileupload-new" onchange="return ShowingImageStudent(this, '#ImgFather','lnkFRemove');" />
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 text-center b-r reg-Moth-detail">
                                                                                    ...
                                                                                    <div class="useimg">
                                                                                        ...
                                                                                        <input type="file" id="fuMother" class="filesearch inputfilehide  fileupload-new" onchange="return ShowingImageStudent(this, '#ImgMother','lnkMRemove');" />
                                                                                        <img src="" id="ImgMother" alt="" style="height:100px; width:100px;cursor:pointer;border: 3px solid #e6e5e5;" class="img-circle" onerror="return fRemove();" onclick="ImgUpload('fuMother');" />
                                                                                        <a class="remove-M-img tooltip4" id="lnkMRemove" onclick="return fRemove('ImgMother','lnkMRemove','lnkMAdd')">
                                                                                            <i class="glyphicon glyphicon-remove-sign"></i>
                                                                                            <span class="tooltiptext">Remove Photo</span>
                                                                                        </a>
                                                                                        <a class="add-M-img tooltip4" id="lnkMAdd" onclick="ImgUpload('fuMother');">
                                                                                            <i class="icon icon-ios-compose"> </i>
                                                                                            <span class="tooltiptext">Add Photo</span>
                                                                                        </a>
                                                                                    </div>
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        <div class="col-md-12 text-center">
                                                                                            <label class="control-label" style="font-size: 17px; color: #00c0ef; "> Any Sibling in Suncity School ?(Real brother/sister)</label>&nbsp;&nbsp;&nbsp;
                                                                        ...
                                                                        <div class="timeline-body">
                                                                            ...
                                                                            <div class="form-group">
                                                                                <div class="col-md-10 col-md-offset-1 text-center" style="margin-bottom:30px;">
                                                                                    <input type="button" id="btnSave" value="Submit" class="btn btn-primary btn-size-md" style="width:85px" tabindex="0" onclick="return fPostData();" />
                                                                                    ...
                                                                                    <input type="submit" id="btnClose" value="Close" class="btn btn-default btn-size-md" style="width:85px" onclick="return fClosReg();" tabindex="0" />
