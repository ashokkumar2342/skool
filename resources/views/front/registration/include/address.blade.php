        ...
        <div class="col-lg-5">
            <div class="form-horizontal">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <input type="text" name="p_pincode" value="{{ $pr->p_pincode }}" class="form-control input-sm" id="PemPinCodes" style="text-transform:uppercase;" autocomplete="off" maxlength="6"  required />
                            <b class="floating-lable">Pin code</b>
                        </div>
                    </div>
