                       ...
                       <div class="box-body">
                           ...
                           <div class="form-group">
                               <div class="col-md-12 bd">                           
                                    <p>Academic Session :<b></b>{{ $pr->academic_years->name  or '' }}</p>
                           ...
                           <div class="form-group">
                               <div class="col-md-12 bd">
                               <p>Mother Tongue : <b>{{ $pr->tongue }}</b></p>
               ...
               <div class="col-lg-6">
                   <div class="form-horizontal">
                       <div class="box-body">
                           ...
                           <div class="form-group">
                               <div class="col-md-12 bd">
                                 <p>Religion :<b>{{ $pr->religion_id }}</b> </p> 
                               </div>
                           </div> 
                           <div class="form-group">
                               <div class="col-sm-12 bd">
                           ...
                           <div class="form-group">
                               <div class="col-sm-12 bd">
                                <p>Gender :<b>{{ $pr->gender_id }}</b> </p>
                                   
                               </div>
                           </div>
                           <div class="form-group">
                                   <div class="col-sm-12 bd">
                                    <p>Blood Group : <b>{{ $pr->blood_group }}</b> </p> 
                                   </div>
                               </div>
                           ...
                           <div class="form-group">
                               <div class="col-md-12 bd">
                                 <p>Category:<b> {{ $pr->category_id }} </b></p>
               ...
               <div class="col-lg-6 b-r">
                   <div class="form-horizontal">
                       <div class="box-body">
                           ...
                           <div class="form-group">
                               <div class="col-md-12 bd">                                                                    
                                   Occupation :<b> {{ $pr->f_occupation }} </b>
                               </div>
                           </div>
                           ...
                           <div class="form-group" >
                               <div class="col-md-12 bd"> 
                                   Annual Income :<b> {{ $pr->f_office_telephone }}</b>
                    ...
                    <div class="col-lg-6 b-r">
                        <div class="form-horizontal">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 bd"> 
                                        Occupation  : <b> {{ $pr->m_occupation }}</b>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 bd">
                                        ...
                                        Annual Income : <b>{{ $pr->m_annual_income }} </b>
                      ...
                      <div class="box-body">
                          ...
                          <div class="form-group">
                              <div class="col-md-12 bd">
                                  ...
                                  Occupation : <b>{{ $pr->g_occupation }} </b>
                              </div>
                          </div>
                          ...
                          <div class="form-group" >
                              <div class="col-md-12 bd">
                                  ...
                                  Annual Income : <b>{{ $pr->g_office_telephone }}</b>
