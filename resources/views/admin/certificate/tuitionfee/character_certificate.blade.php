 ...
 <div align="center" style="padding-top: 40px">
   ...
   <p style="padding-left:10px">this is to certify that Master/Miss <b>pulkit</b> Son/Daughter of Smt. <b>{{ $student->mother_name }}</b>  and Sh. <b>{{ $student->father_name }}</b> has passed <b>{{ $student->classes->name }}</b> Examination vide Roll No.<b>{{ $student->roll_no }}</b>  held in {{ date('d-m-Y') }} as a regular student of this institution His/her Date of Birth as per our school record is <b>{{ date('d-M-Y',strtotime($student->dob)) }}</b></p>
