 ...
 <div align="center" style="padding-top: 40px">
   ...
   <p style="padding-left:10px;padding-top: 20px">this is to certify that Master/Miss <b>pulkit</b> Son/Daughter of Smt.<b>{{ $student->mother_name }} </b> and Sh. <b>{{ $student->father_name }}</b> Adm. No. <b>{{ $student->admission_no }}</b> is a bonafide student  of Clss 8th of this school His/Her date of birth as per our school record is <b>{{ date('d-M-Y',strtotime($student->dob)) }}</b>
