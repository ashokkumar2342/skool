 	...
 	<h4 align="center"><b>Student Details</b></h4><hr>
 	                     ...
 	                     <div class="row" style="margin-left: 80px" style="margin-left: 80px"> 
                             ...
                             <div class="row" style="margin-left: 80px"> 
                              ...
                              <div class="row" style="margin-left: 80px"> 
                               <div class="col-lg-6">
                                    <p>Section : <b>{{ $student->sectionTypes->name or '' }}</b></p> 
                               </div>
            ...
            <h4 align="center"><b>Medical Details</b></h4><hr>
             ...
             <h4 align="center"><b> Sibling Details</b></h4><hr>
                      @foreach ($studentSiblingInfos as $studentSiblingInfo)
                           ...
                           <div class="row" style="margin-left: 80px"> 
 	 	                     <div class="col-lg-6"> 
                                <p>Registration No :<b> {{ $studentSiblingInfo->siblings->registration_no or '' }}</b> </p>   
                              </div>
                              <div class="col-lg-6"> 
                                <p>Name :<b>{{ $studentSiblingInfo->siblings->name  or ''}}</b> </p>  
                              </div>
                           </div>
                           <div class="row" style="margin-left: 80px"> 
 	 	                     <div class="col-lg-6"> 
                                <p>Class:<b> {{ $studentSiblingInfo->siblings->classes->name  or '' }}</b> </p>  
                              </div>
                              <div class="col-lg-6"> 
                                <p>Section :<b>{{ $studentSiblingInfo->siblings->sectionTypes->name or ''  }}</b> </p>  
                              </div>
                           </div>
                      @endforeach
            <h4 align="center"><b> Subject Details</b></h4><hr>
                        ...
                        <div class="row" style="margin-left: 80px"> 
 	 	                  <div class="col-lg-12">  
 	 	                    ...
 	 	                    {{--  <div class="col-lg-6"> 
                                <p>Subject Name:<b> {{ $studentSubject->SubjectTypes->name }}</b> </p>   
                              </div>
                              <div class="col-lg-6"> 
                                <p>ISOptional:<b>{{ $studentSubject->ISOptionals->name }}</b> </p>  
                              </div>
                           </div>  --}}
