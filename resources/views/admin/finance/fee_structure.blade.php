                ...
                <div class="col-md-12"> 
	                <form class="form-horizontal" id="form_fee_account">                                                     
	                   <div class="col-lg-2">                                             
                           ...
                           {{ Form::label('code','Code',['class'=>'form-control']) }}
                    ...
                    <table id="fee_structure_table" class="display table">                     
                        ...
                        @foreach ($feeStructures as $feeStructure)
                        	<tr>
                        		...
                        		<td> 
                        			<button type="button" class="btn_edit btn btn-warning btn-xs" data-toggle="modal" data-id="{{ $feeStructure->id }}"  data-code="{{ $feeStructure->code }}" data-name="{{ $feeStructure->name }}" data-description="{{ $feeStructure->description }}" data-target="#add_parent"><i class="fa fa-edit"></i> </button>
