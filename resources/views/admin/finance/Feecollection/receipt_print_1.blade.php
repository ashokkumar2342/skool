  	 @if ($is_print==1)
  	 	 	  <button type="button" id="btn_print" onclick="printJS({
  	 	  printable: '{{ route('admin.studentFeeCollection.print',$r_arr_id) }}',
  	 	  type: 'pdf',
  	 	  showModal: true,
  	 	  modalMessage: 'Document Printing...'
  	 	})">
  	 	 	     Print PDF
  	 	 	  </button>
	   	                     ...
	   	                     @if ($balance !=0)
	   	                     	<tr>  
	   	                     	   <td  style="font-weight: bold; font-size: small;">
	   	                     	    ...
	   	                     	    <td align="right" style=" font-size: small;">
	   	                     	        <span id="lblLess" style="font-family:Arial;font-size:Small;">{{ $balance  }}</span>
	   	                     	    </td>
	   	                     	</tr> 
	   	                     @endif
	   	            ...
	   	            <div style="width: 450px;" align="Left">
	   	                ...
	   	                <table width="100%" style=" font-size: small;">
	   	                    <tr>
	   	                        ...
	   	                        <th align="right" style=" font-size: small;">
	   	                            <span id="lblLess" style="font-family:Arial;font-size:Small;"></span>
	   	                        </th>
	   	                    </tr>  
