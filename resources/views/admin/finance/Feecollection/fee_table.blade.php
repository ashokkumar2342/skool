                        ...
                        <div style="width: 450px;">
                            <table width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span id="lblReceiptDate" style="font-size:Small;">{{ date('d-m-Y',strtotime($cashbook->receipt_date)) }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" style="font-weight: bold; font-size: small;">
                        ...
                        <div style="width: 450px; margin-top: 10px;">
                            <table width="100%" cellpadding="1">
                               ...
                               $StudentFeeDetail =new  App\Model\StudentFeeDetail();
                                $StudentFeeDetailArrId =explode(',',$cashbook->student_fee_details_id); 
                                $StudentFeeDetails = $StudentFeeDetail->getFeeDetailsByArrId($StudentFeeDetailArrId);
                               ...
                               @endphp
                                @foreach ($FeeDetails as $feeName =>$FeeDetail) 
                                     ...
                                     <tr>
                                         <td align="left" style="font-weight: bold; font-size: small;">
                                             <span id="lblRegistraionFees" style="display:inline-block;font-family:Arial;font-size:Small;text-align: left;">{{ $feeName}}  </span>
                                         </td>
                                         <td align="right" style="font-size: small;">
                                             <span id="lblRegFees" style="font-family:Arial;font-size:Small;">{{ $FeeDetail->sum('fee_amount')}}  </span>
                                         </td>
                                     </tr>
                                @endforeach
                               
                                @if ($cashbook->concession !=0 )
                                     <tr>
                                    <td align="left" style="font-weight: bold; font-size: small;">
                                    ...
                                    <td align="right" style="font-size: small;">
                                        <span id="lblAdmissionFees" style="font-family:Arial;font-size:Small;">{{ $cashbook->concession }}</span>
                                    </td>
                                </tr> 
                                @endif    
                                @if ($cashbook->previous_balance !=0 )
                                     <tr>
                                    <td align="left" style="font-weight: bold; font-size: small;">
                                        <span id="lblAdmissionFee" style="display:inline-block;font-family:Arial;font-size:Small;width:120px;text-align: left;">Previous Balance</span>
                                    </td>
                                    <td align="right" style="font-size: small;">
                                        <span id="lblAdmissionFees" style="font-family:Arial;font-size:Small;">{{ $cashbook->previous_balance }}</span>
                                    </td>
                                </tr> 
                                @endif 
                                @if ($cashbook->fine_amount !=0 )
                                     <tr>
                                    <td align="left" style="font-weight: bold; font-size: small;">
                                        <span id="lblAdmissionFee" style="display:inline-block;font-family:Arial;font-size:Small;width:120px;text-align: left;">Fine Amount</span>
                                    </td>
                                    <td align="right" style="font-size: small;">
                                        <span id="lblAdmissionFees" style="font-family:Arial;font-size:Small;">{{ $cashbook->fine_amount }}</span>
                                    </td>
                                </tr> 
                                @endif
                                ...
                                <tr>
                                    <td align="Right" style="font-weight: bold; font-size: small;">
                                        <span id="lblSSDiscount1" style="display:inline-block;font-family:Arial;font-size:Small;width:120px;text-align: left;">Net Amount</span>
                                    </td>
                                    <td align="right" style="border-style: solid none none none; font-size: small;">
                                        <span id="lblPayableFees" style="font-family:Arial;font-size:Small;">{{ $cashbook->receipt_amount }}</span>
                                    </td>
                                </tr>
