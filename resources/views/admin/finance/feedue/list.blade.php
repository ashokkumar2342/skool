    ...
    <section class="content">
        <div class="box">             
            ...
            <div class="box-body"> 
                <div class="row">  
                    <div class="col-md-12">  
                        <form  class="add_form" method="post" action="{{ route('admin.feeDue.filter') }}" success-content-id="result_div_id" no-reset="true" data-table-without-pagination="result_table_id">
                        {{ csrf_field() }}
