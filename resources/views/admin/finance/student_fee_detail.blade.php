            ...
            <div class="box-body">             
                <div class="col-md-12"> 
                  <form class="form-vertical" id="form_fee_structure_last_date">
                         ...
                         <div class="col-lg-2">                           
                             <div class="form-group">
                              {{ Form::label('fee_structure_id','Fee Structure Last Date',['class'=>' control-label']) }}
                               {{ Form::select('fee_structure_id',$feeStructurLastDate,null,['class'=>'form-control']) }}
                               <p class="errorAmount1 text-center alert alert-danger hidden"></p>
                             </div>    
                        </div>
                         <div class="col-lg-2">                           
                             <div class="form-group">
                              {{ Form::label('fee_structure_id','Concession',['class'=>' control-label']) }}
                               {{ Form::select('fee_structure_id',$concession,null,['class'=>'form-control']) }}
                               <p class="errorAmount1 text-center alert alert-danger hidden"></p>
                             </div>    
                        </div> 
                       <div class="col-lg-2">                                             
