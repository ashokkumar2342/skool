@foreach ($students as $student)
	...
	<tr>
		...
		<td>
			<button type="button" class="btn btn-success btn-xs" button-click="btn_close" success-popup="true" onclick="callAjax(this,'{{ route('admin.studentFeeAssign.search.list.select',App\Helper\MyFuncs::menuPermission()->id) }}'+'?registration_no='+$('#registration_no').val()+'&academic_year_id='+$('#academic_year_id').val(),'student_fee_assign_show')"><i class="fa fa-eye"></i></button> 
		</td>
	</tr>
@endforeach