    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">          
          ...
          <button id="btn_event_type_table_show" hidden data-table="event_type_data_table" onclick="callAjax(this,'{{ route('admin.house.table.show') }}','event_type_table_show_div')">show </button>
          <div class="box"> 
