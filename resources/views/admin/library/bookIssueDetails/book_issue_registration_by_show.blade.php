...
<div class="col-lg-4">
 ...
 <div class="col-lg-4">
	...
	<input type="text" class="form-control" name="mobile" disabled="" value="{{ $student->primary_mobile or ''}}"> 
 </div>
 <div class="col-lg-4">
 	<label>Email</label>
 ...
 <div class="col-lg-8">
 	<label>Address</label>
 	<textarea class="form-control" disabled="" name="name">{{ $student->p_address or '' }}</textarea>
