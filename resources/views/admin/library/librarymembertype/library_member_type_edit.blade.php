  ...
  <div class="modal-dialog" style="width:90%">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <div class="row"> 
        <div class="col-md-12">
          <form action="{{ route('admin.library.member.type.update',$librarymembertypes->id) }}" method="post" class="add_form" button-click="btn_library_member_ship_type_table_show,btn_close">
                   {{ csrf_field() }}
                   <div class="row">
                    <div class="col-lg-6">
