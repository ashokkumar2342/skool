<div class="row">
 ...
 --}}
                    ...
                    <button  id="btn_upload_photo" style="margin-left: 35%" class="btn btn-primary btn-xs" crop-image="true" onclick="callPopupLarge(this,'{{ route('admin.profile.photo') }}')">Upload Photo</button>
