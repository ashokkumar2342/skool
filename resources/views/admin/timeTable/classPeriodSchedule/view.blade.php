...
@section('body')
  ...
  <section class="content-header">
    ...
    <h1>Class Period Schedule<small>list</small> </h1>
       
    </section>  
    <section class="content">
      <div class="row">
        <div class="col-xs-12">  
        <form action="{{ route('admin.class.period.schedule.store') }}" method="post" class="add_form">
              {{ csrf_field() }}         
          <div class="box"> 
            <div class="box-body"> 
              <div class="row">
                <div class="col-lg-4">
                  ...
                  <select name="time_table_type" class="form-control" multiselect-form="true" onchange="callAjax(this,'{{ route('admin.class.period.schedule.show') }}','history_wise_timing')">
