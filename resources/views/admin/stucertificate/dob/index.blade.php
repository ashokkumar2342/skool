...
<section class="content-header" style="margin-top: -20px">
  <h3>DOB Certificate Application</h3>
    ...
    <section class="content" style="margin-top: -15px"> 
      <div class="box">
        <div class="box-body">
        <form action="{{ route('admin.student.BirthCertificateApplicationStore') }}" method="post" class="add_form">
        {{ csrf_field() }}
        <div class="row"> 
          ...
          <div class="col-lg-1 form-group">
            <button type="button" success-popup="true" class="btn btn-primary" style="margin-top: 24px" onclick="callAjax(this,'{{ route('admin.student.BirthCertificateApplicationForm') }}'+'?Registration_no='+$('#Registration_no').val(),'slc_form_div')">Show</button>
          </div> 
           @endif 
          <div id="slc_form_div">
