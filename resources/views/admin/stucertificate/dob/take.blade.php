...
<div class="modal-body">
 <form action="{{ route('admin.student.BirthCertificateIssueTakeStore',$DOBCertIssueDetails->id) }}" method="post" class="add_form" button-click="btn_close,btn_slc_table_show">
