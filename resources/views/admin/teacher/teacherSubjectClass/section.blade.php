...
<div class="col-lg-4">
  ...
  <select name="subject" class="form-control" success-popup="true" onchange="callAjax(this,'{{ route('admin.teacher.subject.wise.period') }}'+'?class_id='+$('#class_id').val(),'no_of_period')">
