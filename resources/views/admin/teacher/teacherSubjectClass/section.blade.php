...
<div class="col-lg-4">
  <label>Subject</label>
  <select name="subject" class="form-control" success-popup="true" onchange="callAjax(this,'{{ route('admin.teacher.subject.wise.period') }}'+'?class_id='+$('#class_id').val()+'&section_id='+$('#section_id').val(),'no_of_period')">
