  ...
  <div class="modal-dialog" style="width:90%">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Teacher Details add</h4>
      </div>
      <div class="modal-body">
       <div class="row"> 
        <div class="col-md-12"> 
             <form action="{{ route('admin.teacher.details.store') }}" method="post" class="add_form" button-click="btn_close,teacher_table_show" >
              {{ csrf_field() }}
              <div class="row">
                <div class="col-lg-4">
                  <label>Code</label>
                ...
                <div class="col-lg-4">
                  ...
                  <input type="text" name="father" class="form-control" placeholder="" maxlength="50"> 
                </div>
                <div class="col-lg-4">
                  <label>Relation</label>
                  <input type="text" name="relation" class="form-control" placeholder="" maxlength="50"> 
                </div>
                <div class="col-lg-4">
                  <label>Mobile</label>
